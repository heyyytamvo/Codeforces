...
void BFS(Position startPoint){
    ...
    while (!waitingQueue.empty()){
        ...
        for (int i = 0; i < 4; i++){
            ...
            if (field[newX][newY] == '.' && visited[newX][newY] == false){
                visited[newX][newY] = true;
                waitingQueue.push((Position) {newX, newY});
                continue;
            }            

            if (field[newX][newY] == 'k' && visited[newX][newY] == false){
                //DEBUGcout << "Sheep at: " << newX << " " << newY << endl;
                sheepInArea += 1;
                visited[newX][newY] = true;
                waitingQueue.push((Position) {newX, newY});
                continue;
            ...
            if (field[newX][newY] == 'v' && visited[newX][newY] == false){
                //DEBUGcout << "Wolf at: " << newX << " " << newY << endl;
                wolfInArea += 1;
                visited[newX][newY] = true;
                waitingQueue.push((Position) {newX, newY});
                continue;
